<x-guest-layout>
    ...
    <section>
        <div class="relative h-full max-w-6xl px-8 py-12 mx-auto md:px-12 lg:pt-24 lg:px-32">
            <div class="lg:p-20 lg:text-center">
                ...
                <div class="flex flex-col gap-2 mt-12 md:flex-row lg:justify-center">
                    <a href="#pricing"
                        class="flex items-center justify-center w-auto h-10 px-4 py-2 text-sm font-semibold text-white transition-all rounded-full shrink-0 bg-accent-500 hover:bg-accent-400">See
                        our pricing</a><a href="#services"
                        class="flex items-center justify-center w-auto h-10 px-4 py-2 text-sm font-semibold text-gray-900 transition-all bg-gray-100 rounded-full shrink-0 hover:bg-gray-200">Checkout
                        our services</a>
                </div>
            </div>
        </div>
